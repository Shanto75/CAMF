    ...
    <div class="container" data-aos="fade-up">
      <header class="section-header">
        ...
        <p>
          ...
          ipsum dolor sit amet consectetur adipisicing elit. Omnis nisi totam
          explicabo corrupti sequi commodi libero hic maxime tempore voluptatum
          facilis, soluta necessitatibus beatae placeat est possimus et sunt
          aliquam!. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Aliquam fugiat earum cum distinctio, consequuntur a suscipit ab et
          explicabo mollitia, officiis quo numquam ipsam, necessitatibus
          similique libero fugit tempore doloribus.
        </p>
      </header>

      <div class="row about-container">
        <div class="col-lg-6 content order-lg-1 order-2 bg-dark">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          ...
          <div class="icon-box bg-dark" data-aos="fade-up" data-aos-delay="100">
            ...
            <h4 class="title">
              <a class="text-light" href="#">Eiusmod Tempor</a>
            </h4>
            <p class="description">
          ...
          <div class="icon-box bg-dark" data-aos="fade-up" data-aos-delay="200">
            ...
            <h4 class="title">
              <a class="text-light" href="#">Magni Dolores</a>
            </h4>
            <p class="description">
          ...
          <div class="icon-box bg-dark" data-aos="fade-up" data-aos-delay="300">
            ...
            <h4 class="title">
              <a class="text-light" href="#">Dolor Sitema</a>
            </h4>
            <p class="description">
        ...
        <div class="col-lg-6 background order-lg-2" data-aos="zoom-in">
          <img src="./../assets/photos/donation.jpg" class="img-fluid" alt="" />
        </div>
      </div>

      <div class="row about-extra">
        <div class="col-lg-6" data-aos="fade-right">
          <img src="./../assets/photos/cover.jpg" class="img-fluid" alt="" />
        </div>
